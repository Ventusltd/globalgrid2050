# GlobalGrid2050 agent restart guide

Read [the owner publication plan](docs/federated-build-plan/PLAN.md) and [the canonical build programme](https://ventusltd.github.io/spiders/codex/build-plan/) before work. Revision202609052048 is a checkpoint, not an instruction to implement every planned item.

Check Git status, branch, remote main and exact release/CI identities first. Preserve adjacent unfinished work; use isolated worktrees and stage only owned paths. Documentation and homepage navigation updates do not promote unaccepted app builds.

This repository owns public publication/composition. Keep collectors and datasets in confirmed owner repositories; do not reactivate old monolith schedules. Preserve original V6 charts while their data federation proceeds in gb-electricity-ui. Core Pipeline News and GridAtlas take priority over optional layers. Keep straight-line calculation available as first pass.
