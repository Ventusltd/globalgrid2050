...
<head>
    ...
    <style>
        ...
        /* The Podcast Tribute */
        .podcast-shoutout {
            position: absolute; bottom: 6px; right: 8px; font-family: -apple-system, sans-serif; font-size: 8px; color: #ffffff;
            opacity: 0.5; text-align: right; text-transform: uppercase; letter-spacing: 1px; pointer-events: none; z-index: 10; text-shadow: 1px 1px 2px #000;
        }
