...
<div class="scada-grid" id="scada-grid">
  ...
  <p class="scada-intro" style="border:1px solid var(--gg-orange);padding:10px 12px;border-radius:4px;color:var(--gg-orange);">V2 development clone. Original tracker remains protected at /uk_energy_tracking/. This page uses V1 live feeds until V2 data pipelines are approved.</p>
