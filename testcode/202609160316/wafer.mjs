...
const POINT = 1.0, ORDER = 'ascending', COLOUR = 'nature';
...
window.__wafer = { law: 'inward-by-length-and-usage', variant: 'inward-by-length-and-usage-plain', place, lawsIndex: LAWS_INDEX };
