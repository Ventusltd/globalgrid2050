...
This file defines the learning objectives that must be completed before advanced SLD, load flow, feeder loading, MCCB, ACB or protection features are added to V7.

The current V7 rule remains:
...
V7 should not simply draw symbols. It should eventually understand parent and child relationships.
...
V7 should not claim load flow until inputs and limits are visible.
...
Future V7 should distinguish transformer nameplate rating from usable capacity under assumptions.
...
V7 should not show MCCB or ACB logic as verified protection design unless settings, fault levels and grading status are available.
...
V7 should first show whether fault level data is present or missing.
...
Future V7 should not assess cable insulation or protection without earthing basis.
...
Future V7 should expose whether these study assumptions exist before showing advanced electrical confidence.
...
Future V7 status fields may include:
...
## 11. What V7 may show first

Before calculations, V7 may safely show:
...
Which V7 module should own the logic?
