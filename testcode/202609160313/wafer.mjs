/* wafer.mjs - the rings-by-membership law, generated. Variation rings-by-membership-plain.
 *
 ...
 */
window.__wafer = {
  law: 'rings-by-membership', variant: 'rings-by-membership-plain', place, lawsIndex: LAWS_INDEX,
