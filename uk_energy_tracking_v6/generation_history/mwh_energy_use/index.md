...
permalink: /uk_energy_tracking_v6/generation_history/mwh_energy_use/
---
...
<div class="scada-grid v6-app" id="mwh-energy-use-module">
  ...
  <section class="mwh-panel">
    ...
    <p class="mwh-note"><a href="/uk_energy_tracking_v6/generation_history/">Back to generation history</a></p>
  </section>
</div>
