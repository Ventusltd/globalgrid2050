...
test "$(git -C "$ROOT" rev-parse 'HEAD:uk_renewables_pipeline/v9.4')" = "dfcd9b457854fc07d4af3df5797f29e2e3d12426"
test "$(git -C "$ROOT" rev-parse 'HEAD:uk_renewables_pipeline/v9.5')" = "457d060161c0edaf9a55cc633ee884ebca5fbe43"
