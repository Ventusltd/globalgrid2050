...
const POINT = 1.3, ORDER = 'descending', COLOUR = 'radiation';
...
window.__wafer = { law: 'inward-by-length-and-usage', variant: 'inward-by-length-and-usage-lit', place, lawsIndex: LAWS_INDEX };
