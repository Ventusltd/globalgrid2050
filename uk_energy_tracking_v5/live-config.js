// V5 live tracker config. Load first.
var ENERGY="/uk_energy_tracking_v5/live_grid_energy.json", PRICE="/uk_energy_tracking_v5/live_grid_price.json", OIL="/uk_energy_tracking_v5/live_oil_prices.json", OIL_HISTORY="/uk_energy_tracking_v5/oil_price_history.geojson", FUEL="/uk_energy_tracking_v5/live_uk_fuel_prices.json", EV_PRICES="/uk_energy_tracking_v5/ev_charging_prices.json", POLL=5*60*1000;
  var GAUGES={
