...
V7 should expose electrical risk controls before it claims electrical design validity.
...
Future V7 should check or record:
...
This does not mean V7 performs a formal arc flash study. It means V7 should show whether the required arc related assumptions and studies exist.

Future V7 should distinguish:
