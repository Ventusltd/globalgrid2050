/* check_v9_9.mjs - the interconnector tab, proven from the bytes, and the
 * v9.9 release identity. Derived from check_v9_8.mjs, which is inherited
 * byte-identical; only the identity assertions at the end move.
 *
...
const PARENT = join(RELEASE, "..", "202609071221");
...
assert.match(html, /scripts\/app-v9-9\.js/);
assert.match(html, /UK RENEWABLES PIPELINE 202609081016/);
assert.doesNotMatch(html, /202609071221\/index|app-v9-8\.js|app-v9-7\.js/);

console.log(`check_v9_9: ${partition.records.length} interconnectors (${manifest.operational} operational, ${manifest.future} future), `
