/* wafer.mjs - the inward-by-length-and-usage law, generated. Variation inward-by-length-and-usage-fine.
 *
 ...
 */
window.__wafer = {
  law: 'inward-by-length-and-usage', variant: 'inward-by-length-and-usage-fine', place, lawsIndex: LAWS_INDEX,
