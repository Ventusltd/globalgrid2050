...
Generated UTC: 2026-05-23T04:38:25.644049+00:00

## Purpose

Working V7 Solar BESS GIS SLD Financial Sandbox reference frame.
...
V7 is the working GIS SLD reference frame. Treat it as the stable baseline. Do not make broad replacements. Study V7 first, then port small proven behaviours into V8.
...
<div class="dashboard">
    <div class="panel panel-left">
        <h2>Solar Photovoltaic (PV) Development, Engineering, Procurement and Construction (EPC) and Grid Analysis</h2>
