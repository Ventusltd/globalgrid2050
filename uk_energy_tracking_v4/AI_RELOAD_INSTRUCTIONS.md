# AI Reload Instructions for UK Energy Tracking V4

Read this file first when restarting work on the UK Energy Tracking V4 page.
...
scripts/isolate_uk_energy_tracking_v4.py
scripts/patch_uk_energy_tracking_v4_transport.py
...
1. Compare V4 against the stable tracker.
2. Inspect V4 JSON feeds.
3. Inspect V4 scripts.
4. Inspect V4 workflows.
5. Patch only V4.
...
```text
Actions -> patch_uk_energy_tracking_v4_transport -> Run workflow
```

## Current mandate

V4 should mirror the stable tracker for core grid behaviour while adding:
...
V4 is the experimental build. New energy graph and price history work should happen here first. Do not disturb V2 unless Vikram approves promotion.
