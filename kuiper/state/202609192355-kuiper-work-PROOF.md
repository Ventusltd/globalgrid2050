...
# Kuiper: what every piece of work changed

## What changed in this release

One small table is released: for each of 7,704 pieces of public work, the code files it changed and the first line it changed in each. Only repositories that are provably public; code and pages, never data. It is read the first time a dot is tapped, and on its own it changes nothing a visitor sees: the part that uses it follows.
...
Score 24 of 24, 2026-09-19T23:33:39Z.
