/* wafer.mjs - the inward-by-length-and-usage law, generated. Variation inward-by-length-and-usage-plain.
 *
 ...
 */
window.__wafer = {
  law: 'inward-by-length-and-usage', variant: 'inward-by-length-and-usage-plain', place, lawsIndex: LAWS_INDEX,
