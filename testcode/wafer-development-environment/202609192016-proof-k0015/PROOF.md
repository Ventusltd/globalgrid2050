...
- A tap that lands in a dark gap between two pieces of work now leads somewhere. It names the next
  piece of work and that name is the way on: tapping it goes there, and the address can be copied
  and sent to somebody else.
- With nothing highlighted, the readout in the top right corner no longer draws an empty box.
...
Score 18 of 18, 2026-09-19T20:06:43Z.
