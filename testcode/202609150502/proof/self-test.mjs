...
check('table layout is pure from measured view inputs',()=>{const v={...view,params:{tableRows:[{i:0,x:100,y:24,height:48},{i:23,x:100,y:76,height:56}]}};table.layout(core,v,a);table.layout(core,structuredClone(v),b);assert.deepEqual(a,b);assert.equal(a[0],100);assert.equal(a[47],76);assert.ok(Number.isNaN(a[2]));});
