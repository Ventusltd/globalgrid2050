# UK Energy Tracking V5 Work Diary

This file is a persistent engineering and AI continuity log for V5.
...
V5 was created so experimental transport energy work would not damage the live public tracker.

## Major lessons learned

### Lesson 1

Do not share feed scripts between stable and V5.

Earlier versions accidentally pointed V5 and stable at the same JSON update logic which caused corruption risk.

Resolution:

```text
create isolated _v2 scripts
create isolated V5 workflows
create isolated V5 JSON outputs
```
...
## Diary entry: 2026-05-26 V5 electricity graph safety patch
...
```text
remove 3 month, 6 month, 12 month, 10 year and all data dropdown options from the visible V5 electricity graph range selector
...
uk_energy_tracking_v5/price-history-fullscreen.js
...
Earlier V5 diary entries remain available in commit history. This condensed entry records the current graph safety patch after the file was updated directly through the GitHub connector.
