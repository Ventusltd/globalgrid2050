/* wafer.mjs - the radius-by-length law, generated. Variation radius-by-length-plain.
 *
 ...
 */
window.__wafer = {
  law: 'radius-by-length', variant: 'radius-by-length-plain', place, lawsIndex: LAWS_INDEX,
