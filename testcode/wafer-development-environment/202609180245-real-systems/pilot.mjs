...
const netCache = {};
const NETWORKS = { underground: 'the London Underground', grid400: 'the 400 kV grid', grid132: 'the 132 kV network', substations: 'every substation', shotwick: 'Shotwick Solar Farm and its grid', uk: 'the British Isles', world: 'the world' };
...
cmds.draw = async function(spec){
  let what = (spec || '').trim().toLowerCase().split(/\s+/)[0] || ''; if (/^(tube|london)$/.test(what)) what = 'underground'; if (what === 'grid') what = 'grid400';
