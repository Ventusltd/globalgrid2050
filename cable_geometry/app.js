...
function populateLookupCSA() {
    ...
    if (isLVpwr) {
        ...
        noteEl.innerHTML = `<strong>LV Power 0.6/1kV ${condLabel} XLPE ${coreLabel} — ${armour}.</strong> ` +
...
function applyLookup() {
    ...
    if (vk === "pv_string") {
        ...
        noteEl.innerHTML = `<strong>LV Power 0.6/1kV ${condLabel} XLPE ${coreLabel} ${armour} — ${csa}mm²:</strong> OD = ${result.od}mm. ` +
