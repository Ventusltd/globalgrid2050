...
(function(){
  ...
  var WEEKLY_URL = "/uk_energy_tracking_v5/live_grid_frequency_weekly_health.json";
  ...
  function install(){
    ...
    section.innerHTML="<h2 class='section-title'>Grid Frequency 24 Hour Trace</h2>"+
      ...
      "<div class='frequency-actions'><strong>UK grid frequency from Elexon</strong><a href='/uk_energy_tracking_v5/grid_frequency_history.csv' download>Download frequency CSV</a><a href='/uk_energy_tracking_v5/grid_frequency_weekly_health.csv' download>Download weekly health CSV</a></div>"+
