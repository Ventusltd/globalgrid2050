...
This document is the authoritative architecture reference for `repd_grid_atlasv7`.
...
| V7 | ventus-corev7engine.js | Experimental | All new features go here |

**URL:** `https://www.globalgrid2050.com/repd_grid_atlasv7/`
...
| Styling | ventusv7.css | Dark-mode SCADA aesthetic, monospace |
| Engine | ventus-corev7engine.js | ~1,350 lines, config-driven |
| Layer config | repd_grid_atlasv7/index.html | HTML data cartridge — source of truth for all layers |
...
**Built by:** `scripts/fetch_naei_point_sourcesv7.py` → GitHub Actions `fetch_naei_point_sources.yml`
...
├── ventus-corev7engine.js              — V7 engine (~1,350 lines)
├── ventusv7.css                        — V7 stylesheet
├── captains_log/
│   ├── version_control.md              — Changelog
│   ├── bug_tracker.md                  — Bug log with root cause analysis
│   └── ARCHITECTURE_V7.md              — This document
└── scripts/
    └── fetch_naei_point_sourcesv7.py   — NAEI emissions annual fetcher
```
