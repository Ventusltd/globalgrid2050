/* check_v9_10.mjs - the interconnector tab, proven from the bytes, and the
 * v9.10 release identity. Derived from check_v9_9.mjs; the interconnector
 * proofs are unchanged and only the identity assertions at the end move.
 *
 ...
 *
 * Run: node tests/check_v9_10.mjs
 */
...
const PARENT = join(RELEASE, "..", "202609081016");
...
assert.match(html, /styles\/v9-10\.css/);
assert.match(html, /UK RENEWABLES PIPELINE 202609082224/);
assert.doesNotMatch(html, /202609081016\/index|app-v9-9\.js|app-v9-7\.js/);

console.log(`check_v9_10: ${partition.records.length} interconnectors (${manifest.operational} operational, ${manifest.future} future), `
