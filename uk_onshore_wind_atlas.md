---
layout: page
title: UK Onshore Wind Atlas
permalink: /uk_onshore_wind_atlas/
---
...
<div class="dashboard-container">
    ...
    <div class="filter-panel">
        <label for="capacityRange">Minimum Wind Farm Size: <span id="capacityVal">0</span> MW</label>
...
<script>
    ...
    Papa.parse(csvUrl, {
        ...
        complete: function(results) {
            // Filter only for Onshore Wind assets on ingestion
            allData = results.data.filter(row => row['Technology Type'] === 'Wind Onshore');
            initDashboard();
        }
    });
    ...
    function updateDisplay(minMW) {
        ...
        if ($.fn.DataTable.isDataTable('#repd-table')) {
            ...
            dataTable = $('#repd-table').DataTable({
                ...
                order: [[2, 'desc']],
                responsive: true,
                language: { search: "Scan Wind Systems:" }
            });
        }
    }
