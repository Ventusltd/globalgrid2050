...
# Kuiper: the page's own checks, matched to the one palette

## What changed in this release

Nothing a visitor sees. The checks the page runs on itself are released as their own part, so that they
ask about the light the page now uses: what is lit must be the pulse's white and ice blue and never the
old green, the month labels must be put away while work is gathered, and an application may spell its
name only when it has a dot for every square of every letter.
...
Score 24 of 24, 2026-09-19T23:08:24Z.
