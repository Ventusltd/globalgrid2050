...
Machine readable map of which lessons apply to which V7 modules.

## Use by future AI

Before proposing a V7 feature:

1. Read `/PHILOSOPHY.md`.
2. Read `solar-bess-topology-v7/docs/ARCHITECTURE.md`.
3. Read this training index.
4. Identify which V7 app is affected.
